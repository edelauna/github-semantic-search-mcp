...
Yes. If you're comfortable using [gitingest](https://github.com/cyclotruc/gitingest) for private repo's then this should be no less secure, as the tool relies on a github access token to run.
